# Install the Boost packages server/ links but does not declare.
#
# Kept in step with metasequoiaime/the Server job in this repository. Boost is linked statically but is not in
...
#
# Appends BOOST_ROOT to GITHUB_ENV, which is the override server/'s CMakeLists.txt supports.
