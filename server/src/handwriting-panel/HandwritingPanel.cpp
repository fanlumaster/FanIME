...
void HandwritingPanel::Render(DeviceResources &resources)
{
    ...
    Text(resources, L"\u6c34\u6749\u624b\u5199\u8bc6\u522b\u677f",
         {headerRect_.x + 14.0f, headerRect_.y, 220.0f, headerRect_.height}, 14.0f, text, DWRITE_TEXT_ALIGNMENT_LEADING,
    ...
    for (size_t i = 0; i < candidateRects_.size(); ++i)
    {
        ...
        Outline(resources, candidateRects_[i], hovered ? accent : border, hovered ? 2.0f : 1.0f, 5.0f);
