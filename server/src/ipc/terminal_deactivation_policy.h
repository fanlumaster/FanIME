...
constexpr bool CanApplyTerminalDeactivationFallback(uint64_t client_id, uint64_t focus_token, uint64_t active_client_id,
                                                    ...
                                                    uint64_t inactive_focus_token)
{
    ...
    return active_client_id == 0 && is_inactive_owner && inactive_focus_token == focus_token;
}
} // namespace FanyImeIpc
