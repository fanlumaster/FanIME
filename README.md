...
这两天涌入的用户太多了，大概有 5000+ 左右，一下子把我的内测的各种 api 额度耗尽了，而且，也带来了很多需求和内测遇到的 bug，我正在改，并且在重构 UI 为原生的专为输入法而开发的 GUI 框架，如果遇到了各种各样的问题，还请耐心等待我的下一次发版，以及，有能力的朋友欢迎来提 PR，本项目接受 **纯 vibe 的 PR**，唯一的要求就是，**不要骂主包**，关于 PR，不管是建设输入法本身，还是输入法背后的 GUI 框架，都非常欢迎。项目预计即将突破 1000 stars，如果你是求职的学生，也很欢迎贡献代码或者和学校、专业相关的词库，并且，输入法是可以直接面向用户的软件，如果你想自己的软件被真实的人所使用、反馈，那么，也很欢迎来贡献。本项目在现在、未来都将保持 100% 开源，并且，开源的目的之一，也是看 AI 目前能不能完善开发这类容错率很低、和系统耦合较深的复杂一点的软件，并且，在一定程度上对抗大厂的这类工具类软件的封锁。
